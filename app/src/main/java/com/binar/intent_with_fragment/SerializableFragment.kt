...
class SerializableFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnNextSerializable.setOnClickListener {
            val serializableIntent = Intent(activity,SerializableActivity::class.java)

            // make object person
            val objSerializable = EmployeeSerializable(etNameSerializable.text.toString(),etAgeSerializable.text.toString().toInt())

            // masukkan object person ke object intent
            serializableIntent.putExtra("objserializable",objSerializable)
